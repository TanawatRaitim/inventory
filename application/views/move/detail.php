				...
				<div class="panel-body">
					<div class="table-responsive">
						...
						<?php foreach($transaction_detail as $row):?>
							<tr id="detail_row">
								<td><input value="1" type="checkbox" name="<?php echo $row['Transact_AutoID']; ?>,<?php echo $row['Product_ID']; ?>,<?php echo $row['Effect_Stock_AutoID']; ?>,delete,1,<?php echo $i; ?>,<?php echo $row['Effect_Stock_Des']; ?>" /></td>
								<td><?php echo $i; ?></td>
								<td><?php echo $row['Product_ID']; ?></td>
								<td><?php echo $row['Stock_Name']; ?> -> <?php echo $row['Effect_Stock_Des_Name']; ?></td>
								<td><input style="width: 70px;" type="text" id="QTY_Good" data-max="<?php echo $row['QTY_Good']; ?>" name="<?php echo $row['Transact_AutoID']; ?>,<?php echo $row['Product_ID']; ?>,<?php echo $row['Effect_Stock_AutoID']; ?>,QTY_Good,<?php echo $row['QTY_Good']; ?>,<?php echo $i; ?>,<?php echo $row['Effect_Stock_Des']; ?>" class="form-control input-sm text-center" value="<?php echo $row['QTY_Good']; ?>" /></td>
								<td><input style="width: 70px;" type="text" id="QTY_Waste" data-max="<?php echo $row['QTY_Waste']; ?>" name="<?php echo $row['Transact_AutoID']; ?>,<?php echo $row['Product_ID']; ?>,<?php echo $row['Effect_Stock_AutoID']; ?>,QTY_Waste,<?php echo $row['QTY_Waste']; ?>,<?php echo $i; ?>,<?php echo $row['Effect_Stock_Des']; ?>" class="form-control input-sm text-center" value="<?php echo $row['QTY_Waste']; ?>" /></td>
								<td><input style="width: 70px;" type="text" id="QTY_Damage" data-max="<?php echo $row['QTY_Damage']; ?>" name="<?php echo $row['Transact_AutoID']; ?>,<?php echo $row['Product_ID']; ?>,<?php echo $row['Effect_Stock_AutoID']; ?>,QTY_Damage,<?php echo $row['QTY_Damage']; ?>,<?php echo $i; ?>,<?php echo $row['Effect_Stock_Des']; ?>" class="form-control input-sm text-center" value="<?php echo $row['QTY_Damage']; ?>" /></td>
