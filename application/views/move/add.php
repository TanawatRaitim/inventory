					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="col-md-12">
								<form class="form-horizontal" role="form">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label">รหัสสินค้า</label>
										<div class="col-sm-8">
									...
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-3 control-label">คลังต้นทาง</label>
										<div class="col-sm-3">
											<select class="form-control input-sm">
												<option>A</option>
												<option>B</option>
										...
										<label for="inputEmail3" class="col-sm-3 control-label">คลังปลายทาง</label>
										<div class="col-sm-3">
											<select class="form-control input-sm">
												<option>A</option>
												<option>B</option>
