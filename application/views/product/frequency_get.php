			...
			<div class="col-md-6">
				...
				<form role="form" name="<?php echo $form_name;?>" enctype="multipart/form-data" id="<?php echo $form_name;?>" method="post" action="<?php echo site_url($form_action);?>">
					<div class="form-group">
					    <label for="ProFreq_Name"><?php echo $name_label;?></label>
					    <?php if(isset($data['ProFreq_ID'])):?>
					    <input type="text" value="<?php echo $data['ProFreq_Name'];?>" class="form-control" id="ProFreq_Name" name="ProFreq_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <input type="hidden" name="ProFreq_ID" id="ProFreq_ID" value="<?php echo $data['ProFreq_ID'];?>" />
					    <?php else:?>
					    <input type="text" class="form-control" id="ProFreq_Name" name="ProFreq_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <?php endif;?>		
