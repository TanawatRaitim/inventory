			...
			<div class="col-md-6">
				...
				<form role="form" name="<?php echo $form_name;?>" enctype="multipart/form-data" id="<?php echo $form_name;?>" method="post" action="<?php echo site_url($form_action);?>">
					<div class="form-group">
					    <label for="ProType_Name"><?php echo $name_label;?></label>
					    <?php if(isset($data['ProType_ID'])):?>
					    <input type="text" value="<?php echo $data['ProType_Name'];?>" class="form-control" id="ProType_Name" name="ProType_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <input type="hidden" name="ProType_ID" id="ProType_ID" value="<?php echo $data['ProType_ID'];?>" />
					    <?php else:?>
					    <input type="text" class="form-control" id="ProType_Name" name="ProType_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <?php endif;?>		
