			...
			<div class="col-md-6">
				...
				<form role="form" name="<?php echo $form_name;?>" enctype="multipart/form-data" id="<?php echo $form_name;?>" method="post" action="<?php echo site_url($form_action);?>">
					<div class="form-group">
					    <label for="ProCat_Name"><?php echo $name_label;?></label>
					    <?php if(isset($data['ProCate_ID'])):?>
					    <input type="text" value="<?php echo $data['ProCat_Name'];?>" class="form-control" id="ProCat_Name" name="ProCat_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <input type="hidden" name="ProCate_ID" id="ProCate_ID" value="<?php echo $data['ProCate_ID'];?>" />
					    <?php else:?>
					    <input type="text" class="form-control" id="ProCat_Name" name="ProCat_Name" placeholder="<?php echo $name_placeholder;?>" autofocus>	
					    <?php endif;?>		
