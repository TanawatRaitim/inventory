					...
					<tbody>
						<tr>
							...
							<td style="width:20px;">
								  ...
								  <a href="/inventory/cut/add" class="btn btn-danger btn-xs">ตัดจ่าย</a>
							</td>
						</tr>
						<tr>
							<td class="text-center">2</td>
							<td class="text-center">RS-57-08-002</td>
							<td>ตัดจ่าย-ดัดแปลง/รวมเล่มใหม่ (TT)</td>
							<td class="text-center">10</td>
							<td class="text-center">04/08/2014</td>
							<td class="text-center">06/08/2014</td>
							<td class="text-center">prapaporn.s</td>
						...
						<tr>
							...
							<td>ตัดจ่าย-ตัดเคลียร์สต็อค (ZZ)</td>
							<td class="text-center">10</td>
							<td class="text-center">04/08/2014</td>
							<td class="text-center">06/08/2014</td>
							<td class="text-center">prapaporn.s</td>
						...
						<tr>
							...
							<td>ตัดจ่าย -ชัวคราวเพื่อซ่อมแซม (MO)</td>
							<td class="text-center">10</td>
							<td class="text-center">04/08/2014</td>
							<td class="text-center">06/08/2014</td>
							<td class="text-center">prapaporn.s</td>
						...
						<tr>
							...
							<td>ตัดจ่าย-สินค้าตัวอย่าง (XS)</td>
							<td class="text-center">10</td>
							<td class="text-center">04/08/2014</td>
							<td class="text-center">06/08/2014</td>
							<td class="text-center">prapaporn.s</td>
