					...
					<form class="form-horizontal" role="form">
						...
						<div class="col-md-5">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label"><?php echo $input_type;?> - </label>
								<div class="col-sm-7">
									<input type="text" class="form-control input-sm" id="product_id" placeholder="รหัสการจอง" autofocus="">
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<input type="text" class="form-control input-sm" id="customer_id" placeholder="เลขที่รหัสลูกค้า">
								</div>
							</div>
						</div>
						...
						<div class="col-md-5">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-5 control-label">วันที่ส่งของ</label>
								<div class="col-sm-7">
									<input type="text" class="form-control input-sm" id="product_id" placeholder="วันที่ส่งของ">
								</div>
							</div>
						</div>
