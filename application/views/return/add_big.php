<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-4">
			<form class="form-horizontal" method="post" action="<?php echo base_url('return_p/add');?>" name="customer_form" id="customer_form">
			  <div class="form-group">
			    <label for="customer" class="col-sm-3 control-label">รหัสลูกค้า</label>
			    <div class="col-sm-7">
			      <input type="text" class="form-control" id="customer" name="customer" placeholder="Customer ID" autofocus >
			    </div>
			    <div class="col-sm-2">
					<button type="submit" class="btn btn-default" name="customer_submit" id="customer_submit">ตกลง</button>
			    </div>
			  </div>
			</form>
		</div>
		<div class="col-md-8">
			...
			<div class="alert alert-success">	
				<?php echo $customer_detail['Cust_ID'];?>
				<?php echo $customer_detail['Cust_Name'];?>
				 (<?php echo $customer_detail['Cust_Contact'];?>)
				<?php echo $customer_detail['Cust_Addr'];?>
			</div>	
			<?php endif;?>	
		</div>
	</div>
