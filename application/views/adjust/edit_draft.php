		...
		<div class="col-md-8">
			<div class="panel panel-info">
				<div class="panel-heading">
					<h3 class="panel-title">รายละเอียดหลักTicket</h3>
				</div>
					...
					<form class="form-horizontal" method="post" role="form" name="main_ticket" id="main_ticket" action="">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="TK_Code" class="col-sm-5 control-label">AD - <span class="text-danger"></span></label>
								<div class="col-sm-7">
									<input type="text" readonly="" value="<?php  echo $transaction['TK_ID'];?>" class="form-control input-sm" id="TK_ID" name="TK_ID" placeholder="Ticket ID">
								</div>
							</div>
						</div>
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								<input type="hidden" name="TK_Code" id="TK_Code" value="AD" />
