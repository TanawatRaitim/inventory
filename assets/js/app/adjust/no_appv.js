        ...
        "columns": [
        	...
        	},
        	{
        		...
        		"render": function(data, type, row){
        			//return "button";
        			//console.log(row);
        			return "<a data-toggle='tooltip' title='ดูรายละเอียด' class='btn btn-xs btn-danger' href='view_detail/"+row.Transact_AutoID+"'>View Detail(WAR)</a> <a data-toggle='tooltip' title='แก้ไข' class='btn btn-xs btn-info' href='approve/"+row.Transact_AutoID+"'>View Detail(ACC)</a>";
        		}
        	}
        ],
