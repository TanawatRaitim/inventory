        ...
        "columns": [
        	...
        	},
        	{
        		...
        		"render": function(data, type, row){
        			//return "button";
        			//console.log(row);
        			return "<a data-toggle='tooltip' title='' class='btn btn-xs btn-danger' href='edit_reject/"+row.Transact_AutoID+"'>View Detail(WAR)</a> <a data-toggle='tooltip' title='' class='btn btn-xs btn-info' href='view_detail/"+row.Transact_AutoID+"'>View Detail(ACC)</a>";
        		}
        	}
        ],
