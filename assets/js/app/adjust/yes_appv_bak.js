        ...
        "columns": [
        	...
        	},
        	{
        		...
        		"render": function(data, type, row){
        			//return "button";
        			console.log(row);
        			return "<a data-toggle='tooltip' title='ดูรายละเอียด' class='btn btn-xs btn-danger' href='view_detail/"+row.TK_ID+"'>View Detail(SDB)</a> <a data-toggle='tooltip' title='แก้ไข' class='btn btn-xs btn-info' href='view_approve/"+row.TK_ID+"'>View Detail(WAR)</a>";
        		}
        	}
        ],
