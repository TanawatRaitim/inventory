$(function() {
	...
	$("form#form_add").validate({
		...
		rules:{
			ProCat_Name:{
				required:true,
				remote: {
					url: BASE_URL + 'product/check_category_name',
					type: 'post',
					data: {
						name: function(){
							return $("#ProCat_Name").val();
						}
					}
				}
			}
	...
	$("form#form_edit").validate({
		...
		rules:{
			ProCat_Name:{
				required:true,
				remote: {
					url: BASE_URL + 'product/check_category_name/edit',
					type: 'post',
					data: {
						name: function(){
							return $("#ProCat_Name").val();
	...
	//table id for datatable
		...
		var table = $("#"+table_id).DataTable( {
			...
			"order": [],
			"dom": 'T<"clear">lfrtip',
	        "ajax": BASE_URL+'product/get_product_category_datatable',
	        "stateSave": true,
	        "tableTools": {
	        	"aButtons": [
	        		{
	        ...
	        "columns": [
	        	...
	        	{"data":"RowStatus"},
	        	{
	        		...
	        		"render": function(data, type, row){
	        			return "<a title='แก้ไข' class='btn btn-xs btn-warning' href='"+BASE_URL+"product/category_get/"+row.ProCate_ID+"'>แก้ไข</a> "; 
	        		}
	        	}	
	        ],
