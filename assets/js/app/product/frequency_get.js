$(function() {
	...
	$("form#form_add").validate({
		...
		rules:{
			ProFreq_Name:{
				required:true,
				remote: {
					url: BASE_URL + 'product/check_frequency_name',
					type: 'post',
					data: {
						name: function(){
							return $("#ProFreq_Name").val();
						}
					}
				}
			}
	...
	$("form#form_edit").validate({
		...
		rules:{
			ProFreq_Name:{
				required:true,
				remote: {
					url: BASE_URL + 'product/check_frequency_name/edit',
					type: 'post',
					data: {
						name: function(){
							return $("#ProFreq_Name").val();
	...
	//table id for datatable
		...
		var table = $("#"+table_id).DataTable( {
			...
			"order": [],
			"dom": 'T<"clear">lfrtip',
	        "ajax": BASE_URL+'product/get_product_frequency_datatable',
	        "stateSave": true,
	        "tableTools": {
	        	"aButtons": [
	        		{
	        ...
	        "columns": [
	        	...
	        	{"data":"RowStatus"},
	        	{
	        		"render": function(data, type, row){
	        			return "<a title='แก้ไข' class='btn btn-xs btn-warning' href='"+BASE_URL+"product/frequency_get/"+row.ProFreq_ID+"'>แก้ไข</a> "; 
	        		}
	        	}	
	        ],
